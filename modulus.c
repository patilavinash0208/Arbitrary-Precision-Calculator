...
void modulus(node *head_L1, node *head_OPR2, node *tail_OPR2, node **headR, node **tailR)
{
    ...
    while(temp != NULL)
    {
        ...
        {
            subtraction(tail_OPR1,tail_OPR2,&head_SR,&tail_SR); //subtract opr2 from opr1 and store in SR list (Remainder storing)
    ...
    *headR = head_OPR1, *tailR = tail_OPR1;
}
